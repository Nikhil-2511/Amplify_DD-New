...
import { offSellertabData } from '../tabModel';

function OffPlatformSeller({tableModel, apiUrl, updateModel}) {
    ...
    const [selectedTab, setSelectedTab] = useState(offSellertabData()[0]);
...
export default OffPlatformSeller;